...
ImageButton.Image = "rbxassetid://16221576129"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    _G.FastAttackthuhien_Mode = Value
	if _G.FastAttackthuhien_Mode == "Fast Attack" then
		_G.Fast_Delay = 0.12
	elseif _G.FastAttackthuhien_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.2
	elseif _G.FastAttackthuhien_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.05
	end
end)
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://16221576129" then
                    return v
                end
            end
        end
...
while wait() do
    pcall(function()
        if _G.FastAttackthuhien then
            repeat wait(_G.DelayAttackPlayer)
               AttackNoCoolDown()
            until not _G.FastAttackthuhien
        end
    end)
end
end)
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://16221576129"
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16221576129" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16221576129" then
            wait(2.0)
        elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16221576129" then
            Hop()
            Fluent:Notify({
                Title = ": thuhien v2.3 hub",
